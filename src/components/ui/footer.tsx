    ...
    <footer>
      <div className="grid md:grid-cols-4 border-b border-foreground/[0.35]">
        ...
        <div className="p-6">
          ...
          <ul className="space-y-3">
            <li>
              <a href="https://x.com/zuolabs" className="group flex items-center gap-3 text-[14px]" style={alphaLyrae}>
                <svg className="w-4 h-4 text-foreground/70 group-hover:text-accent transition-colors" fill="currentColor" viewBox="0 0 24 24">
            ...
            <li>
              <a href="https://github.com/zuolabx" className="group flex items-center gap-3 text-[14px]" style={alphaLyrae}>
                <svg className="w-4 h-4 text-foreground/70 group-hover:text-accent transition-colors" fill="currentColor" viewBox="0 0 24 24">
            ...
            <li>
              <a href="mailto:zuolabx@gmail.com" className="group flex items-center gap-3 text-[14px]" style={alphaLyrae}>
                <svg className="w-4 h-4 text-foreground/70 group-hover:text-accent transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
